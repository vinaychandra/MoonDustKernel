...
//! calls.
//!
//! Derived from https://github.com/emk/toyos-rs
...
impl ChainedPics {
    ...
    pub unsafe fn initialize(&mut self, pic1_mask: Option<u8>, pic2_mask: Option<u8>) {
        ...
        self.pics[0].data.write(pic1_mask.unwrap_or(saved_mask1));
        self.pics[1].data.write(pic2_mask.unwrap_or(saved_mask2));
    }
