...
pub fn main_bsp() -> ! {
    ...
    {
        let af = tasks::keyboard::print_keypresses();
        let af2: alloc::boxed::Box<dyn core::future::Future<Output = u8>> =
            alloc::boxed::Box::new(af);
        let af3 = af2;
        ...
        let bf = tasks::keyboard::print_keypresses();
        let bf2: alloc::boxed::Box<dyn core::future::Future<Output = u8>> =
            alloc::boxed::Box::new(bf);
        let bf3 = bf2;

        // exec.spawn(Priority::Medium, f).detach();
